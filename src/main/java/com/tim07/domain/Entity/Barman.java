...
@Entity
public class Barman extends Employee implements Serializable{
    ...
    public Barman(String username, String password, UserType type, String name, String lastname, String dateOfBirth,
    ...
    public boolean equals(Object regUserObj) {
        Barman regUser = (Barman) regUserObj;
