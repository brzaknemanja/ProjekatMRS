...
insert into manager_restaurant(name, lastname, username, password, email, type, id) values ('djudja', 'cukurov', 'djudja', 'djuli', 'kaca.cukurov@gmail.com', 'RestaurantManager', 18);
...
insert into waiter(name, lastname, username, password, type, date_of_birth, dress_size, shoe_size, id) values ('nemanja', 'brzak', 'brzi', '2222', 'Waiter',  '10.10.1995.', 42, 38, 17);
